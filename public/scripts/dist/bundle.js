...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _views_base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./views/base */ \"./src/views/base.js\");\n/* harmony import */ var _models_ProductSearch__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./models/ProductSearch */ \"./src/models/ProductSearch.js\");\n/* harmony import */ var _models_CategorySearch__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./models/CategorySearch */ \"./src/models/CategorySearch.js\");\n/* harmony import */ var _models_Likes__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./models/Likes */ \"./src/models/Likes.js\");\n/* harmony import */ var _models_Cart__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./models/Cart */ \"./src/models/Cart.js\");\n/* harmony import */ var _views_homeView__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./views/homeView */ \"./src/views/homeView.js\");\n/* harmony import */ var _views_resultsView__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./views/resultsView */ \"./src/views/resultsView.js\");\n/* harmony import */ var _views_productView__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./views/productView */ \"./src/views/productView.js\");\n/* harmony import */ var _views_mainMenuView__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./views/mainMenuView */ \"./src/views/mainMenuView.js\");\n/* harmony import */ var _views_submenuView__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./views/submenuView */ \"./src/views/submenuView.js\");\n/* harmony import */ var _views_cartView__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./views/cartView */ \"./src/views/cartView.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\n\n\n\n\n\n\n\n\n\n // GLOBAL STATE\n// ===========================================================\n\nvar state = {}; // ===========================================================\n// PRODUCTS SEARCH CONTROLLER\n// ===========================================================\n\nvar controlProductSearch =\n/*#__PURE__*/\nfunction () {\n  var _ref = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee(query) {\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            // Create new search object and add to state\n            state.productSearch = new _models_ProductSearch__WEBPACK_IMPORTED_MODULE_1__[\"default\"](query);\n            _context.prev = 1;\n            _context.next = 4;\n            return state.productSearch.getResults();\n\n          case 4:\n            _context.next = 10;\n            break;\n\n          case 6:\n            _context.prev = 6;\n            _context.t0 = _context[\"catch\"](1);\n            alert('Somthing went wrong with the product search');\n            console.log(_context.t0);\n\n          case 10:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee, null, [[1, 6]]);\n  }));\n\n  return function controlProductSearch(_x) {\n    return _ref.apply(this, arguments);\n  };\n}(); // ===========================================================\n// CART CONTROLLER\n// ===========================================================\n\n\nvar controlCart = function controlCart(event) {\n  var idArray = event.currentTarget.id.split('-');\n  var currentIndex = idArray[0];\n  var currentSku = idArray[1];\n  var currentQuantity;\n\n  if (_views_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].productQuantity) {\n    currentQuantity = Number(_views_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].productQuantity.value);\n  } else {\n    currentQuantity = 1;\n  } // Swap icon on 'Add to Cart' button to let user know item is being added to thier cart\n\n\n  Object(_views_base__WEBPACK_IMPORTED_MODULE_0__[\"cartBtnAnimation\"])(event, state.cart.items[currentSku]); // Add the item to the cart model\n\n  state.cart.addItem(currentSku, state.productSearch.results[currentIndex].image, state.productSearch.results[currentIndex].name, state.productSearch.results[currentIndex].regularPrice, currentQuantity); // Update number of cart items in cart icon located in top right corner\n\n  _views_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].headerCartCounter.innerHTML = state.cart.getNumItems();\n}; // ===========================================================\n// CART PAGE CONTROLLER\n// ===========================================================\n\n\nvar controlCartPage = function controlCartPage() {\n  _views_cartView__WEBPACK_IMPORTED_MODULE_10__[\"renderCartGridItems\"](state.cart.items);\n  state.cart.calcTotals();\n  _views_cartView__WEBPACK_IMPORTED_MODULE_10__[\"updateCartSummary\"](state.cart.totals);\n  _views_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].cartGrid.addEventListener('click', function (event) {\n    if (event.target.closest('.cart-grid__quantity')) {\n      var itemSku = event.target.closest('.cart-grid__quantity').id.slice(5);\n\n      if (event.target.matches('.quantity-calc__btns, .quantity-calc__btns *')) {\n        var direction;\n\n        if (event.target.className.includes('up')) {\n          direction = 'up';\n        } else {\n          direction = 'down';\n        }\n\n        Object(_views_base__WEBPACK_IMPORTED_MODULE_0__[\"updateItemQuant\"])(direction, itemSku, function (newQuantity) {\n          state.cart.updateItem(itemSku, newQuantity);\n        });\n        _views_cartView__WEBPACK_IMPORTED_MODULE_10__[\"highlightRefreshBtns\"](itemSku);\n      }\n\n      ;\n\n      if (event.target.matches('.cart-grid__remove-btn, .cart-grid__remove-btn *')) {\n        state.cart.removeItem(itemSku);\n        location.reload(true);\n      }\n\n      if (event.target.matches('.cart-grid__refresh-btn, .cart-grid__refresh-btn *')) {\n        location.reload(true);\n      }\n    }\n  });\n}; // ===========================================================\n// LIKE CONTROLLER\n// ===========================================================\n\n\nvar controlLikes = function controlLikes(event) {\n  var idArray = event.currentTarget.id.split('-');\n  var currentIndex = idArray[0];\n  var currentSku = idArray[1];\n  console.log(currentIndex);\n  console.log(currentSku); // User has NOT yet liked current product\n\n  if (!state.likes.isLiked(currentSku)) {\n    // Add like to the state\n    state.likes.addLike(currentSku, state.productSearch.results[currentIndex].name, state.productSearch.results[currentIndex].image, state.productSearch.results[currentIndex].regularPrice); // Toggle the like button\n\n    if (window.location.pathname === '/results') {\n      _views_resultsView__WEBPACK_IMPORTED_MODULE_6__[\"toggleLikeBtn\"](true, event.currentTarget.querySelector('.product-thumb__like-icon'));\n    } else if (window.location.pathname === '/product') {\n      _views_productView__WEBPACK_IMPORTED_MODULE_7__[\"toggleLikeBtn\"](true, event.currentTarget.querySelector('.product-thumb__like-icon'));\n    } // Add like to UI list\n\n\n    console.log(localStorage);\n    console.log(state.likes); // User HAS liked the current product\n  } else {\n    // Remove like to the state\n    state.likes.deleteLike(currentSku); // Toggle the like button\n\n    if (window.location.pathname === '/results') {\n      _views_resultsView__WEBPACK_IMPORTED_MODULE_6__[\"toggleLikeBtn\"](false, event.currentTarget.querySelector('.product-thumb__like-icon'));\n    } else if (window.location.pathname === '/product') {\n      _views_productView__WEBPACK_IMPORTED_MODULE_7__[\"toggleLikeBtn\"](false, event.currentTarget.querySelector('.product-thumb__like-icon'));\n    } // Remove like to UI list\n\n\n    console.log(localStorage);\n    console.log(state.likes);\n  }\n}; // ===========================================================\n// RESULTS PAGE CONTROLLER\n// ===========================================================\n\n\nvar controlResultsPage =\n/*#__PURE__*/\nfunction () {\n  var _ref2 = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee2() {\n    var urlQuery, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, cartBtn, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, likeBtn;\n\n    return regeneratorRuntime.wrap(function _callee2$(_context2) {\n      while (1) {\n        switch (_context2.prev = _context2.next) {\n          case 0:\n            // Get search query from url parameter\n            urlQuery = window.location.search;\n\n            if (!urlQuery) {\n              _context2.next = 14;\n              break;\n            }\n\n            _context2.prev = 2;\n            _context2.next = 5;\n            return controlProductSearch(urlQuery);\n\n          case 5:\n            // Determine if any products are 'Liked' by user\n            state.productSearch.results.forEach(function (element) {\n              if (!state.likes.isLiked(element.sku)) {} else {\n                element.liked = true;\n              }\n            }); // Render results on UI\n\n            state.productSearch.results.forEach(function (element, index) {\n              element.index = index;\n            });\n            _views_resultsView__WEBPACK_IMPORTED_MODULE_6__[\"renderResults\"](state.productSearch.results);\n            _context2.next = 14;\n            break;\n\n          case 10:\n            _context2.prev = 10;\n            _context2.t0 = _context2[\"catch\"](2);\n            alert('Somthing went wrong when attempting to render product search results');\n            console.log(_context2.t0);\n\n          case 14:\n            // EVENT LISTENERS\n            // ===========================================================\n            // When page buttons on Results page are clicked\n            _views_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].resultsPages.addEventListener('click', function (event) {\n              var btn = event.target.closest('.btn');\n\n              if (btn) {\n                var goToPage = parseInt(btn.dataset[\"goto\"], 10);\n                _views_resultsView__WEBPACK_IMPORTED_MODULE_6__[\"clearResults\"]();\n                _views_resultsView__WEBPACK_IMPORTED_MODULE_6__[\"renderResults\"](state.productSearch.results, goToPage);\n              }\n\n              ;\n            }); // When 'Add to Cart' button is clicked\n\n            _iteratorNormalCompletion = true;\n            _didIteratorError = false;\n            _iteratorError = undefined;\n            _context2.prev = 18;\n\n            for (_iterator = document.querySelectorAll('.product-thumb__cart-btn')[Symbol.iterator](); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {\n              cartBtn = _step.value;\n              cartBtn.addEventListener('click', controlCart);\n            } // When 'like' buttons on Results page are clicked\n\n\n            _context2.next = 26;\n            break;\n\n          case 22:\n            _context2.prev = 22;\n            _context2.t1 = _context2[\"catch\"](18);\n            _didIteratorError = true;\n            _iteratorError = _context2.t1;\n\n          case 26:\n            _context2.prev = 26;\n            _context2.prev = 27;\n\n            if (!_iteratorNormalCompletion && _iterator[\"return\"] != null) {\n              _iterator[\"return\"]();\n            }\n\n          case 29:\n            _context2.prev = 29;\n\n            if (!_didIteratorError) {\n              _context2.next = 32;\n              break;\n            }\n\n            throw _iteratorError;\n\n          case 32:\n            return _context2.finish(29);\n\n          case 33:\n            return _context2.finish(26);\n\n          case 34:\n            _iteratorNormalCompletion2 = true;\n            _didIteratorError2 = false;\n            _iteratorError2 = undefined;\n            _context2.prev = 37;\n\n            for (_iterator2 = document.querySelectorAll('.product-thumb__like-btn')[Symbol.iterator](); !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {\n              likeBtn = _step2.value;\n              likeBtn.addEventListener('click', controlLikes);\n            }\n\n            _context2.next = 45;\n            break;\n\n          case 41:\n            _context2.prev = 41;\n            _context2.t2 = _context2[\"catch\"](37);\n            _didIteratorError2 = true;\n            _iteratorError2 = _context2.t2;\n\n          case 45:\n            _context2.prev = 45;\n            _context2.prev = 46;\n\n            if (!_iteratorNormalCompletion2 && _iterator2[\"return\"] != null) {\n              _iterator2[\"return\"]();\n            }\n\n          case 48:\n            _context2.prev = 48;\n\n            if (!_didIteratorError2) {\n              _context2.next = 51;\n              break;\n            }\n\n            throw _iteratorError2;\n\n          case 51:\n            return _context2.finish(48);\n\n          case 52:\n            return _context2.finish(45);\n\n          case 53:\n          case \"end\":\n            return _context2.stop();\n        }\n      }\n    }, _callee2, null, [[2, 10], [18, 22, 26, 34], [27,, 29, 33], [37, 41, 45, 53], [46,, 48, 52]]);\n  }));\n\n  return function controlResultsPage() {\n    return _ref2.apply(this, arguments);\n  };\n}(); // ===========================================================\n// PRODUCT PAGE CONTROLLER\n// ===========================================================\n\n\nvar controlProductPage =\n/*#__PURE__*/\nfunction () {\n  var _ref3 = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee3() {\n    var urlQuery, _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, navItem, productThumbs, _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, element;\n\n    return regeneratorRuntime.wrap(function _callee3$(_context3) {\n      while (1) {\n        switch (_context3.prev = _context3.next) {\n          case 0:\n            // Get search query from url parameter\n            urlQuery = window.location.search;\n\n            if (!urlQuery) {\n              _context3.next = 13;\n              break;\n            }\n\n            _context3.prev = 2;\n            _context3.next = 5;\n            return controlProductSearch(urlQuery);\n\n          case 5:\n            // Render results on UI\n            _views_productView__WEBPACK_IMPORTED_MODULE_7__[\"renderProduct\"](state.productSearch.results[0]);\n            _views_productView__WEBPACK_IMPORTED_MODULE_7__[\"renderLikeBtn\"](state.likes.isLiked(state.productSearch.results[0].sku), state.productSearch.results[0].sku);\n            _context3.next = 13;\n            break;\n\n          case 9:\n            _context3.prev = 9;\n            _context3.t0 = _context3[\"catch\"](2);\n            alert('Somthing went wrong when attempting to render product.');\n            console.log(_context3.t0);\n\n          case 13:\n            ; // EVENT LISTENERS\n            // ===========================================================\n\n            _views_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].productMain.addEventListener('click', function (event) {\n              var itemSku = _views_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].productSku.innerHTML; // When product quantity buttons are clicked\n\n              if (event.target.matches('.quantity-calc__btns, .quantity-calc__btns *')) {\n                var direction;\n\n                if (event.target.className.includes('up')) {\n                  direction = 'up';\n                } else {\n                  direction = 'down';\n                }\n\n                Object(_views_base__WEBPACK_IMPORTED_MODULE_0__[\"updateItemQuant\"])(direction, itemSku, function (newQuantity) {\n                  _views_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].productPrice.innerHTML = (newQuantity * state.productSearch.results[0].regularPrice).toFixed(2);\n                });\n              }\n            }); // When nav titles are clicked\n\n            _iteratorNormalCompletion3 = true;\n            _didIteratorError3 = false;\n            _iteratorError3 = undefined;\n            _context3.prev = 18;\n\n            for (_iterator3 = _views_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].productNavItems[Symbol.iterator](); !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {\n              navItem = _step3.value;\n              navItem.addEventListener('click', _views_productView__WEBPACK_IMPORTED_MODULE_7__[\"navItemsEvents\"]);\n            }\n\n            _context3.next = 26;\n            break;\n\n          case 22:\n            _context3.prev = 22;\n            _context3.t1 = _context3[\"catch\"](18);\n            _didIteratorError3 = true;\n            _iteratorError3 = _context3.t1;\n\n          case 26:\n            _context3.prev = 26;\n            _context3.prev = 27;\n\n            if (!_iteratorNormalCompletion3 && _iterator3[\"return\"] != null) {\n              _iterator3[\"return\"]();\n            }\n\n          case 29:\n            _context3.prev = 29;\n\n            if (!_didIteratorError3) {\n              _context3.next = 32;\n              break;\n            }\n\n            throw _iteratorError3;\n\n          case 32:\n            return _context3.finish(29);\n\n          case 33:\n            return _context3.finish(26);\n\n          case 34:\n            ; // When thumb images are clicked\n\n            productThumbs = document.querySelectorAll('.product-gallery__thumb-wrap');\n            _iteratorNormalCompletion4 = true;\n            _didIteratorError4 = false;\n            _iteratorError4 = undefined;\n            _context3.prev = 39;\n\n            for (_iterator4 = productThumbs[Symbol.iterator](); !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {\n              element = _step4.value;\n              element.addEventListener('click', _views_productView__WEBPACK_IMPORTED_MODULE_7__[\"thumbImgsEvents\"]);\n            }\n\n            _context3.next = 47;\n            break;\n\n          case 43:\n            _context3.prev = 43;\n            _context3.t2 = _context3[\"catch\"](39);\n            _didIteratorError4 = true;\n            _iteratorError4 = _context3.t2;\n\n          case 47:\n            _context3.prev = 47;\n            _context3.prev = 48;\n\n            if (!_iteratorNormalCompletion4 && _iterator4[\"return\"] != null) {\n              _iterator4[\"return\"]();\n            }\n\n          case 50:\n            _context3.prev = 50;\n\n            if (!_didIteratorError4) {\n              _context3.next = 53;\n              break;\n            }\n\n            throw _iteratorError4;\n\n          case 53:\n            return _context3.finish(50);\n\n          case 54:\n            return _context3.finish(47);\n\n          case 55:\n            ; // When 'Add to Cart' button is clicked\n\n            _views_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].productCartBtn.addEventListener('click', controlCart); // When 'Like' button is clicked\n\n            document.querySelector('.product-info__like-btn').addEventListener('click', controlLikes);\n\n          case 58:\n          case \"end\":\n            return _context3.stop();\n        }\n      }\n    }, _callee3, null, [[2, 9], [18, 22, 26, 34], [27,, 29, 33], [39, 43, 47, 55], [48,, 50, 54]]);\n  }));\n\n  return function controlProductPage() {\n    return _ref3.apply(this, arguments);\n  };\n}(); // ===========================================================\n// CATEGORIES SEARCH CONTROLLER\n// ===========================================================\n\n\nvar controlCategorySearch =\n/*#__PURE__*/\nfunction () {\n  var _ref4 = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee4() {\n    return regeneratorRuntime.wrap(function _callee4$(_context4) {\n      while (1) {\n        switch (_context4.prev = _context4.next) {\n          case 0:\n            // New category search object and add to state\n            state.categorySearch = new _models_CategorySearch__WEBPACK_IMPORTED_MODULE_2__[\"default\"]();\n            _context4.prev = 1;\n            _context4.next = 4;\n            return state.categorySearch.getResults();\n\n          case 4:\n            _context4.next = 10;\n            break;\n\n          case 6:\n            _context4.prev = 6;\n            _context4.t0 = _context4[\"catch\"](1);\n            alert('Somthing went wrong with the categories search');\n            console.log(_context4.t0);\n\n          case 10:\n          case \"end\":\n            return _context4.stop();\n        }\n      }\n    }, _callee4, null, [[1, 6]]);\n  }));\n\n  return function controlCategorySearch() {\n    return _ref4.apply(this, arguments);\n  };\n}(); // ===========================================================\n// HEADER CONTROLLER\n// ===========================================================\n\n\nvar controlHeader =\n/*#__PURE__*/\nfunction () {\n  var _ref5 = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee5() {\n    return regeneratorRuntime.wrap(function _callee5$(_context5) {\n      while (1) {\n        switch (_context5.prev = _context5.next) {\n          case 0:\n            _context5.prev = 0;\n            _context5.next = 3;\n            return controlCategorySearch();\n\n          case 3:\n            _context5.next = 9;\n            break;\n\n          case 5:\n            _context5.prev = 5;\n            _context5.t0 = _context5[\"catch\"](0);\n            alert('Somthing went wrong when attempting to render subcategories.');\n            console.log(_context5.t0);\n\n          case 9:\n            // Organize the results to be used for rendering\n            state.categorySearch.organizeResults(); // Add modifier classes to each main menu item: main-menu__item--1\n\n            _views_submenuView__WEBPACK_IMPORTED_MODULE_9__[\"addModClass\"](_views_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].mainMenuItems, 'main-menu__item'); // Render the submenus with subcategories for each main menu category\n\n            _views_submenuView__WEBPACK_IMPORTED_MODULE_9__[\"renderSubMenus\"](state.categorySearch.allSubCatArrays); // Update number of items showing in header cart icon\n\n            _views_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].headerCartCounter.innerHTML = state.cart.getNumItems(); // EVENT LISTENERS\n            // ===========================================================\n            // Open/close main menu\n\n            _views_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].mainMenuBtn.addEventListener('click', function () {\n              _views_mainMenuView__WEBPACK_IMPORTED_MODULE_8__[\"toggleDropdown\"](_views_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].mainMenuDropdown);\n            }); // Close main menu when click anywhere outside of mainmenu\n\n            document.addEventListener('click', function (event) {\n              _views_mainMenuView__WEBPACK_IMPORTED_MODULE_8__[\"hideOnClickOutside\"](event, _views_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].mainMenuDropdown);\n            }); // Open/close main menu\n\n            _views_submenuView__WEBPACK_IMPORTED_MODULE_9__[\"setUpSubmenuEvent\"]('mouseover', _views_submenuView__WEBPACK_IMPORTED_MODULE_9__[\"showSubMenu\"]);\n            _views_submenuView__WEBPACK_IMPORTED_MODULE_9__[\"setUpSubmenuEvent\"]('mouseleave', _views_submenuView__WEBPACK_IMPORTED_MODULE_9__[\"hideSubMenu\"]); // Header notice close button\n\n            _views_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].headerNoticeBtn.addEventListener('click', function () {\n              Object(_views_base__WEBPACK_IMPORTED_MODULE_0__[\"hideElement\"])(_views_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].headerNotice);\n            });\n\n          case 18:\n          case \"end\":\n            return _context5.stop();\n        }\n      }\n    }, _callee5, null, [[0, 5]]);\n  }));\n\n  return function controlHeader() {\n    return _ref5.apply(this, arguments);\n  };\n}(); // ===========================================================\n// HOME PAGE CONTROLLER\n// ===========================================================\n\n\nvar controlHomePage = function controlHomePage() {\n  _views_homeView__WEBPACK_IMPORTED_MODULE_5__[\"beginBackgroundFade\"]();\n}; // ===========================================================\n// INITIALIZE APPLICATION\n// ===========================================================\n\n\nvar init = function init() {\n  // Restore cart and saved/liked items on page load\n  // window.addEventListener('load', () => {\n  state.likes = new _models_Likes__WEBPACK_IMPORTED_MODULE_3__[\"default\"]();\n  state.likes.readLocalStorage();\n  state.cart = new _models_Cart__WEBPACK_IMPORTED_MODULE_4__[\"default\"]();\n  state.cart.readLocalStorage();\n  console.log(localStorage);\n  console.log(state); // });\n\n  controlHeader();\n\n  if (window.location.pathname === '/product') {\n    controlProductPage();\n  } else if (window.location.pathname === '/results') {\n    controlResultsPage();\n  } else if (window.location.pathname === '/cart') {\n    controlCartPage();\n  } else {\n    controlHomePage();\n  }\n};\n\ninit();\n\n//# sourceURL=webpack:///./src/index.js?");
