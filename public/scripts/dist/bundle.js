...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return controlHeader; });\n/* harmony import */ var _views_submenuView__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../views/submenuView */ \"./src/views/submenuView.js\");\n/* harmony import */ var _views_mainMenuView__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../views/mainMenuView */ \"./src/views/mainMenuView.js\");\n/* harmony import */ var _views_headerView__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../views/headerView */ \"./src/views/headerView.js\");\n/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../index */ \"./src/index.js\");\n/* harmony import */ var _views_base__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../views/base */ \"./src/views/base.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\n\n\n\n // HEADER CONTROLLER\n// ===========================================================\n\nfunction controlHeader(_x) {\n  return _controlHeader.apply(this, arguments);\n}\n\nfunction _controlHeader() {\n  _controlHeader = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(apiKey) {\n    return regeneratorRuntime.wrap(function _callee2$(_context2) {\n      while (1) {\n        switch (_context2.prev = _context2.next) {\n          case 0:\n            _context2.prev = 0;\n            _context2.next = 3;\n            return Object(_index__WEBPACK_IMPORTED_MODULE_3__[\"controlCategorySearch\"])(apiKey);\n\n          case 3:\n            _context2.next = 9;\n            break;\n\n          case 5:\n            _context2.prev = 5;\n            _context2.t0 = _context2[\"catch\"](0);\n            alert('Something went wrong when attempting to render subcategories.');\n            console.log(_context2.t0);\n\n          case 9:\n            // Organize the results\n            _index__WEBPACK_IMPORTED_MODULE_3__[\"state\"].categorySearch.organizeResults(); // Add 'modifier' class to each main menu item: main-menu__item--1\n\n            _views_submenuView__WEBPACK_IMPORTED_MODULE_0__[\"addModClass\"](_views_base__WEBPACK_IMPORTED_MODULE_4__[\"elements\"].mainMenuItems, 'main-menu__item'); // Render the submenus with subcategories for each main menu category\n\n            _views_submenuView__WEBPACK_IMPORTED_MODULE_0__[\"renderSubMenus\"](_index__WEBPACK_IMPORTED_MODULE_3__[\"state\"].categorySearch.allSubCatArrays); // Update number of items in users cart icon (top right)\n\n            _views_base__WEBPACK_IMPORTED_MODULE_4__[\"elements\"].headerCartCounter.innerHTML = _index__WEBPACK_IMPORTED_MODULE_3__[\"state\"].cart.getNumItems(); // Event Listeners\n            // ===========================================================\n\n            _views_base__WEBPACK_IMPORTED_MODULE_4__[\"elements\"].siteHeader.addEventListener('click', function (event) {\n              // Event handler for open/close main menu\n              if (event.target.matches('.main-menu__btn, .main-menu__btn *') || event.target.matches('.main-menu__header-icon')) {\n                _views_mainMenuView__WEBPACK_IMPORTED_MODULE_1__[\"toggleDropdown\"](_views_base__WEBPACK_IMPORTED_MODULE_4__[\"elements\"].mainMenuDropdown);\n              } // Event handler for user's account menu (after logged in)\n\n\n              if (_views_base__WEBPACK_IMPORTED_MODULE_4__[\"elements\"].accountMenuDropdown != null) {\n                // Toggle account dropdown menu\n                if (event.target.matches('.account-btn, .account-btn *')) {\n                  _views_mainMenuView__WEBPACK_IMPORTED_MODULE_1__[\"toggleDropdown\"](_views_base__WEBPACK_IMPORTED_MODULE_4__[\"elements\"].accountMenuDropdown);\n                } // When 'Liked Items' link is clicked in the account menu\n\n\n                if (event.target.matches('.account-menu__link--liked-items, .account-menu__link--liked-items *')) {\n                  event.preventDefault();\n\n                  if (_index__WEBPACK_IMPORTED_MODULE_3__[\"state\"].likes.likes.length === 0) {\n                    _views_headerView__WEBPACK_IMPORTED_MODULE_2__[\"showNoLikesMsg\"]();\n                  } else {\n                    window.location = '/results/likes';\n                  }\n                } // When 'Shopping Cart' link is clicked in the account menu\n\n\n                if (event.target.matches('.account-menu__link--shopping-cart, .account-menu__link--shopping-cart *')) {\n                  event.preventDefault();\n\n                  if (Object.keys(_index__WEBPACK_IMPORTED_MODULE_3__[\"state\"].cart.items).length === 0) {\n                    _views_headerView__WEBPACK_IMPORTED_MODULE_2__[\"showNoItemsMsg\"]();\n                  } else {\n                    window.location = '/cart';\n                  }\n                } // When logout link is clicked\n\n\n                if (event.target.matches('.account-menu__link--logout, .account-menu__link--logout *')) {\n                  var logout = /*#__PURE__*/function () {\n                    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n                      return regeneratorRuntime.wrap(function _callee$(_context) {\n                        while (1) {\n                          switch (_context.prev = _context.next) {\n                            case 0:\n                              _context.prev = 0;\n                              _context.next = 3;\n                              return axios.post('/accounts/logout', {\n                                cart: _index__WEBPACK_IMPORTED_MODULE_3__[\"state\"].cart.items,\n                                likes: _index__WEBPACK_IMPORTED_MODULE_3__[\"state\"].likes.likes\n                              }).then(function () {\n                                _index__WEBPACK_IMPORTED_MODULE_3__[\"state\"].cart.clearLocalStorage();\n                                _index__WEBPACK_IMPORTED_MODULE_3__[\"state\"].likes.clearLocalStorage();\n                                window.location = window.location.href;\n                              });\n\n                            case 3:\n                              _context.next = 8;\n                              break;\n\n                            case 5:\n                              _context.prev = 5;\n                              _context.t0 = _context[\"catch\"](0);\n                              console.log(_context.t0);\n\n                            case 8:\n                            case \"end\":\n                              return _context.stop();\n                          }\n                        }\n                      }, _callee, null, [[0, 5]]);\n                    }));\n\n                    return function logout() {\n                      return _ref.apply(this, arguments);\n                    };\n                  }();\n\n                  event.preventDefault();\n                  logout();\n                }\n              } // When Cart link is clicked\n\n\n              if (event.target.matches('.cart-link, .cart-link *')) {\n                event.preventDefault();\n\n                if (Object.keys(_index__WEBPACK_IMPORTED_MODULE_3__[\"state\"].cart.items).length === 0) {\n                  _views_headerView__WEBPACK_IMPORTED_MODULE_2__[\"showNoItemsMsg\"]();\n                } else {\n                  window.location = '/cart';\n                }\n              }\n            }); // Event handler when user clicks anywhere outside of main menu or account menu\n\n            document.addEventListener('click', function (event) {\n              if (_views_base__WEBPACK_IMPORTED_MODULE_4__[\"elements\"].mainMenuDropdown.classList.contains('is-visible')) {\n                _views_mainMenuView__WEBPACK_IMPORTED_MODULE_1__[\"hideOnClickOutside\"](event, _views_base__WEBPACK_IMPORTED_MODULE_4__[\"elements\"].mainMenuDropdown);\n              } else if (_views_base__WEBPACK_IMPORTED_MODULE_4__[\"elements\"].accountMenuDropdown != null && _views_base__WEBPACK_IMPORTED_MODULE_4__[\"elements\"].accountMenuDropdown.classList.contains('is-visible')) {\n                _views_mainMenuView__WEBPACK_IMPORTED_MODULE_1__[\"hideOnClickOutside\"](event, _views_base__WEBPACK_IMPORTED_MODULE_4__[\"elements\"].accountMenuDropdown);\n              }\n            }); // Event handler for open/close submenus of main menu\n\n            if (!(screen.width < 576)) {\n              _views_submenuView__WEBPACK_IMPORTED_MODULE_0__[\"setUpSubmenuEvent\"]('mouseover', _views_submenuView__WEBPACK_IMPORTED_MODULE_0__[\"showSubMenu\"]);\n              _views_submenuView__WEBPACK_IMPORTED_MODULE_0__[\"setUpSubmenuEvent\"]('mouseleave', _views_submenuView__WEBPACK_IMPORTED_MODULE_0__[\"hideSubMenu\"]);\n            } else {\n              _views_submenuView__WEBPACK_IMPORTED_MODULE_0__[\"setUpSubmenuEvent\"]('click', _views_submenuView__WEBPACK_IMPORTED_MODULE_0__[\"toggleSubMenu\"]);\n            } // Event handler for clicking 'X' (close) icon at very top of header\n\n\n            _views_base__WEBPACK_IMPORTED_MODULE_4__[\"elements\"].headerNoticeBtn.addEventListener('click', function () {\n              hideElement(_views_base__WEBPACK_IMPORTED_MODULE_4__[\"elements\"].headerNotice);\n            });\n\n          case 17:\n          case \"end\":\n            return _context2.stop();\n        }\n      }\n    }, _callee2, null, [[0, 5]]);\n  }));\n  return _controlHeader.apply(this, arguments);\n}\n\n//# sourceURL=webpack:///./src/controllers/header.js?");
