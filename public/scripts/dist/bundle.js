...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Search; });\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\nvar Search =\n/*#__PURE__*/\nfunction () {\n  function Search(query) {\n    var catID = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';\n\n    _classCallCheck(this, Search);\n\n    this.query = query;\n    this.catID = catID;\n    this.results = [];\n  }\n\n  _createClass(Search, [{\n    key: \"formatQuery\",\n    value: function formatQuery() {\n      // i.e. input is \"?search=red+dead+redemption\"\n      var queryArray = this.query.trim().slice(8).split('+');\n      var addToString = \"search=\\'\";\n      var newQueryArray = [];\n      queryArray.forEach(function (element) {\n        newQueryArray.push(addToString.concat(element) + \"\\'\");\n      });\n      return newQueryArray.join('&'); // i.e. output would be 'search=\"red\"&search=\"dead\"&search=\"redemption\"\n    }\n  }, {\n    key: \"getResults\",\n    value: function () {\n      var _getResults = _asyncToGenerator(\n      /*#__PURE__*/\n      regeneratorRuntime.mark(function _callee() {\n        var baseURL, apiType, keyWords, attribute, catID, apiKey, sortOptions, showOptions, pageSize, active, responseFormat, totalPages, i, response;\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                baseURL = 'https://api.bestbuy.com/v1/', apiType = 'products', keyWords = this.formatQuery(), attribute = '&customerReviewAverage>0', catID = \"\".concat(this.catID), apiKey = 'MORTkmhIyQS3N3Pahuta4gSd', sortOptions = '&sort=bestSellingRank.asc', showOptions = '&show=sku,name,salePrice,regularPrice,customerReviewAverage,customerReviewCount,bestSellingRank,categoryPath.name,categoryPath.id,thumbnailImage,image', pageSize = '&pageSize=100', active = '&active=true', responseFormat = '&format=json';\n                totalPages = 1;\n                i = 0;\n\n              case 3:\n                if (!(i < totalPages)) {\n                  _context.next = 18;\n                  break;\n                }\n\n                _context.prev = 4;\n                _context.next = 7;\n                return axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(\"\".concat(baseURL).concat(apiType, \"((\").concat(keyWords, \")\").concat(attribute).concat(catID, \")?apiKey=\").concat(apiKey).concat(sortOptions).concat(showOptions).concat(pageSize, \"&page=\").concat(i + 1).concat(active).concat(responseFormat));\n\n              case 7:\n                response = _context.sent;\n                this.results = this.results.concat(response.data.products);\n                totalPages = response.data.totalPages;\n                _context.next = 15;\n                break;\n\n              case 12:\n                _context.prev = 12;\n                _context.t0 = _context[\"catch\"](4);\n                console.error(_context.t0);\n\n              case 15:\n                i++;\n                _context.next = 3;\n                break;\n\n              case 18:\n              case \"end\":\n                return _context.stop();\n            }\n          }\n        }, _callee, this, [[4, 12]]);\n      }));\n\n      function getResults() {\n        return _getResults.apply(this, arguments);\n      }\n\n      return getResults;\n    }()\n  }]);\n\n  return Search;\n}();\n\n\n\n//# sourceURL=webpack:///./src/models/Search.js?");
...
/*!**********************************!*\
  !*** ./src/views/submenuView.js ***!
  \**********************************/
/*! exports provided: addModClass, setUpSubmenuEvent, showSubMenu, hideSubMenu */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
